<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="/">
		...
		<xsl:choose>
			...
			<xsl:when test="/xml2sql/TRANSACTION_SET/ORDER_REF_DETAILS">
				...
				<HTML>
					...
					<FONT FACE="VERDANA, ARIAL, HELVETICA" SIZE="2">
						<B>
							<xsl:value-of
								select="/xml2sql/TRANSACTION_SET/ORDER_REF_DETAILS/@ORD_REF_NUM" />
						</B>
			...
			<xsl:when test="/xml2sql/TRANSACTION_SET/ORDER_EVENT_DETAILS/ORD_EVENT">
				...
				<HTML>
					...
					<FONT FACE="VERDANA, ARIAL, HELVETICA" SIZE="2">We are please to
						inform you of the following details of your Order.</FONT>
					<BR />
					<BR />
					...
					<TABLE CELLPADDING="4" CELLSPACING="1">
						...
						<TR>
							<TD WIDTH="200" HEIGHT="25">
								<FONT FACE="VERDANA, ARIAL, HELVETICA" SIZE="2">Order Reference
									Number</FONT>
							</TD>
							<TD>
								<FONT FACE="VERDANA, ARIAL, HELVETICA" SIZE="2">
									<B>
										<xsl:value-of
											select="/xml2sql/TRANSACTION_SET/ORDER_EVENT_DETAILS/@ORD_REF_NUM" />
									</B>
								</FONT>
							</TD>
						</TR>
						<TR>
							...
							<TD>
								<FONT FACE="VERDANA, ARIAL, HELVETICA" SIZE="2">
									<B>
										<xsl:value-of
											select="/xml2sql/TRANSACTION_SET/ORDER_EVENT_DETAILS/@ORDER_SOURCE" />
									</B>
								</FONT>
							</TD>
						</TR>
						<TR>
							...
							<TD>
								<FONT FACE="VERDANA, ARIAL, HELVETICA" SIZE="2">
									<B>
										<xsl:value-of
											select="/xml2sql/TRANSACTION_SET/ORDER_EVENT_DETAILS/@ORDER_DEST" />
									</B>
								</FONT>
							</TD>
						</TR>
					...
					<FONT FACE="VERDANA, ARIAL, HELVETICA" SIZE="2">
						<B>Sequence of events occured on order,</B>
					</FONT>
					<BR />
					<BR />
					...
					<TABLE BORDER="1" CELLPADDING="4" CELLSPACING="0">
						...
						<xsl:for-each
							select="/xml2sql/TRANSACTION_SET/ORDER_EVENT_DETAILS/ORD_EVENT">
			...
			<xsl:when test="/xml2sql/TRANSACTION_SET/ORDER_EVENT_DETAILS">
				<HTML>
					<a href="http://www.inspirage.com">
					...
					<FONT FACE="VERDANA, ARIAL, HELVETICA" SIZE="2">Event data cannot
						be display because no activity has been done on your Order yet.</FONT>
					<BR />
					<BR />
					<TABLE CELLPADDING="4" CELLSPACING="1">
						<TR>
